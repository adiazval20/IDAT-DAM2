...
public class InscripcionEventoVirtualController implements BaseController<InscripcionEventoVirtual, Long> {
    ...
    @GetMapping("/evento-persona/{eventoVirtualId}/{personaId}")
    public GenericResponse findByEventoPersona(@PathVariable long eventoVirtualId, @PathVariable long personaId) {
        return service.findByEventoPersona(eventoVirtualId, personaId);
    }
