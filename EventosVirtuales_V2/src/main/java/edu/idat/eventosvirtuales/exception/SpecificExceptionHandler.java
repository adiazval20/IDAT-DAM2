...
public class SpecificExceptionHandler {
    ...
    public GenericResponse fileNotFound(MyFileNotFoundException ex) {
        return new GenericResponse("file-not-found-exception", RPTA_WARNING, OPERACION_ERRONEA, ex.getMessage());
    }
}
